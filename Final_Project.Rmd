...
The two datasets that I patched together were taken from the FEC's regularly maintained website. The unit of observation is *committee id*. Below you can see the variables of interest:
```{r}
head(new_data)
```
